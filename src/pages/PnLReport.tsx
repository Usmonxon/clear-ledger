...
export default function PnLReport() {
  ...
  const { monthKeys, data } = useMemo(() => {
    const filtered = transactions.filter((t) => t.currency === currency && t.type !== "transfer");
    ...
    filtered.forEach((t) => {
      ...
      // Use cashflow_category as the single unified category
    ...
    return { monthKeys, data: { incomeCategories, expenseCategories, incomeTotals, expenseTotals } };
